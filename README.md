...
- экспериментальный план выплаты с тремя ориентирами — точным TP нуля, TP желаемой чистой прибыли и округлённым TP для постановки;
- настоящий split и reward cycle модели, дата выплаты, прогресс прибыльных дней и отдельные guards Equity / Profit Concentration / Striking;
- явный фактический TP или SL Bybit после стопа FundingPips, включённый в общий результат фермы;
